import type { Card, CardColor, StackingMode, TurnState } from '../../shared/engine'
...
export type ServerMsg =
    ...
    | { t: 'error'; code: 'unauthorized' | 'bad-message' | 'room-not-found' | 'not-host' | 'not-started' | 'already-started' | 'need-players' | 'invalid-intent'; intentId?: string }
